...
class AgentConfig(BaseModel):
    ...
    prompt: Optional[Dict[str, Union[str, List[str]]]] = None
    conditional_routing: Optional[Dict[str, Any]] = None
    intents: Optional[Dict[str, str]] = None
    intent_slots: Optional[Dict[str, List[str]]] = None
    default_intent: Optional[str] = None
    domains: Optional[Dict[str, str]] = None
    intent_domain_mapping: Optional[Dict[str, str]] = None
    default_domain: Optional[str] = None
    missing_slots_tools: Optional[Dict[str, List[str]]] = None
    tools: Optional[Dict[str, str]] = None
    intent_tool_mapping: Optional[Dict[str, str]] = None
