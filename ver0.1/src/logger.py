...
class Logger:
    ...
    def _should_log_to_agent_handler(self) -> bool:
        """Agent I/O 핸들러에 로그할지 결정합니다."""
        # Agent와 Tool 관련 로거만 Agent I/O 핸들러에 기록
        agent_related_names = [
            "SuperSOL.Agent",
            "SuperSOL.Tool",
            "SuperSOL.Agent.supervisor",
            "SuperSOL.Agent.domain_banking",
            "SuperSOL.Agent.domain_asset_management",
            "SuperSOL.Agent.worker_customer_info",
            "SuperSOL.Agent.worker_financial_info",
            "SuperSOL.Agent.worker_transfer",
            "SuperSOL.Agent.worker_account",
            "SuperSOL.Agent.worker_auto_transfer",
            "SuperSOL.Agent.worker_investment_products",
            "SuperSOL.Agent.worker_loan",
            "SuperSOL.Agent.quality_check"
        ]
        return self.name in agent_related_names
    ...
    def _setup_handlers(self) -> None:
        ...
        # Agent I/O 로깅 핸들러 (Agent와 Tool 관련 로거만)
        if self._should_log_to_agent_handler():
